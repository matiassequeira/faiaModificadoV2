...
public class DepthFirstSearch extends Strategy {
	...
	private Vector<NTree> ramaExpandida;
	...
	public void setRamaExpandida(Vector<NTree> ramaExpandida) {
		this.ramaExpandida = ramaExpandida;
	}

	public Vector<NTree> getRamaExpandida() {
		return ramaExpandida;
	}
}
